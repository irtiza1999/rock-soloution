    ...
    for (let i = 0; i < 10; i++) {
        ...
        searchResult.innerHTML += `<div class="single-result row my-3 p-3 d-flex justify-content-between align-items-center">
                                    <div class="col-md-9">
                                        ...
                                        <p><a href="${link}" id="linkLink">Listen now</p>
                                    </div>
                                    <div>
                                       <img src="${albumCover}" alt="">
                                    </div>
                                    <div class="col-md-12 text-md-right text-center">
                                        <button id="getBtn" class="getLyrics btn btn-success" onclick="getLyrics(this)">Get Lyrics</button>
                                    </div>
                                </div>`
    }
}
